...
/*function desafio (valor)
{
    ...
    for(let i = 0; i < valor; i++){
        ...
        if(lista_Valores[i] % 3 === 0 || lista_Valores[i] % 5 === 0 )
        {            
            lista_ValoresFinais.push(lista_Valores[i])
                       
        }   
    }
    for (let i = 0; i < lista_ValoresFinais.length; i++) {
        total += lista_ValoresFinais[i];
      }
    return total
}
